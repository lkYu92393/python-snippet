...
class CVGenerator(FPDF):
    ...
    def render_education(self, education):
        ...
        for edu in education:
            ...
            # Check space before each education entry
            self.check_space(40)
    ...
    def generate(self, contact_info, jobs, education=None, languages=None, 
        ...
        for section_type in section_order:
            if section_type in renderers:
                # Skip space check for first section and work_experience
                if not first_section and section_type != 'work_experience':
                    # Different minimum space based on section type
                    min_space = {
                        'education': 40,
                        'languages': 30,
                        'skills': 30,
